CLASS lsc_zey_ab_travel DEFINITION INHERITING FROM cl_abap_behavior_saver.
...
CLASS lsc_zey_ab_travel IMPLEMENTATION.
...
CLASS lhc_Travel DEFINITION INHERITING FROM cl_abap_behavior_handler.
  PRIVATE SECTION.
    ...
    TYPES: t_entity_create TYPE TABLE FOR CREATE zey_ab_travel,
           t_entity_update TYPE TABLE FOR UPDATE zey_ab_travel,
           t_entity_rep    TYPE TABLE FOR REPORTED zey_ab_travel,
           t_entity_err    TYPE TABLE FOR FAILED zey_ab_travel.
...
CLASS lhc_Travel IMPLEMENTATION.
  ...
  METHOD get_instance_authorizations.
    ...
    READ ENTITIES OF zey_ab_travel IN LOCAL MODE
        ENTITY travel
...
*            ENDIF.
  ...
  METHOD earlynumbering_create.
    ...
    DATA: entity        TYPE STRUCTURE FOR CREATE zey_ab_travel,
...
*        CATCH cx_number_ranges.
  ...
  METHOD copyTravel.
    ...
    DATA: travels       TYPE TABLE FOR CREATE zey_ab_travel\\Travel,
          bookings_cba  TYPE TABLE FOR CREATE zey_ab_travel\\Travel\_Booking,
          booksuppl_cba TYPE TABLE FOR CREATE zey_ab_travel\\Booking\_BookingSupplement.
    ...
    MODIFY ENTITIES OF zey_ab_travel IN LOCAL MODE
        ENTITY travel
...
*             entities_c =
  ...
  METHOD acceptTravel.
    ...
    MODIFY ENTITIES OF zEY_AB_travel
        ENTITY travel
    ...
    READ ENTITIES OF zEY_AB_travel
        ENTITY Travel
            ALL FIELDS
                WITH CORRESPONDING #( keys )
