CLASS zey_ab_data_builder DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS ZEY_AB_DATA_BUILDER IMPLEMENTATION.


  METHOD fill_master_data.
    data : lt_bp type table of zey_ab_bpa,
           lt_prod type table of zey_ab_product.
   ...
   append value #(
    ...
    append value #(
     ...
     insert zey_ab_bpa from table @lt_bp.
     insert zey_ab_product from table @lt_prod.
  ENDMETHOD.
  ...
  METHOD fill_transaction_data.
    data : o_rand type REF TO cl_abap_random_int,
           ...
           lv_ord_id type zey_ab_dte_id,
           lt_so type table of zey_ab_so_hdr,
           lt_so_i type table of zey_ab_so_item.
    ...
    select * from zey_ab_bpa into table @data(lt_bpa).
    select * from zey_ab_product into table @data(lt_prod).
    ...
    insert zey_ab_so_hdr from table @lt_so.
    insert zey_ab_so_item from table @lt_so_i.

  ENDMETHOD.


  METHOD flush.
    delete from : zey_ab_bpa, zey_ab_product, zey_ab_so_hdr, zey_ab_so_item.
  ENDMETHOD.
