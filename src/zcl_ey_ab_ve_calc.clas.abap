CLASS zcl_ey_ab_ve_calc DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS ZCL_EY_AB_VE_CALC IMPLEMENTATION.
  ...
  METHOD if_sadl_exit_calc_element_read~calculate.
    ...
    data: lt_calc_data type standard table of zey_ab_travel_processor with DEFAULT KEY,
