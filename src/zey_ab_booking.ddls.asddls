...
define view entity ZEY_AB_BOOKING as select from /dmo/booking_m
composition[0..*] of ZEY_AB_BOOKSUPPL as _BookingSupplement
association to parent ZEY_AB_TRAVEL as _Travel on
